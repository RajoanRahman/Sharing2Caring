...
public class JatrabariRidePosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jatrabari_ride_posts);

        rideShareBar=findViewById(R.id.jatrabari_ride_app_bar);
        setSupportActionBar(rideShareBar);
        getSupportActionBar().setTitle("Jatrabari Area");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        postRef=FirebaseDatabase.getInstance().getReference().child("JatrabariPosts");

        rideSharePostList=findViewById(R.id.jatrabari_rideShare_post_recyclerView);
        ...
        floatingActionButton=findViewById(R.id.jatrabari_openRide_post);
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(JatrabariRidePosts.this,Jatrabari.class);
    ...
    private void displayAlluserPost() {
        FirebaseRecyclerAdapter<RideSharePostModel,JatrabariRidePostViewHolder> firebaseRecyclerAdapter=
                new FirebaseRecyclerAdapter<RideSharePostModel, JatrabariRidePostViewHolder>
                        (RideSharePostModel.class,R.layout.ride_share_post_layout,JatrabariRidePostViewHolder.class,postRef) {
                    @Override
    ...
    public static class JatrabariRidePostViewHolder extends RecyclerView.ViewHolder{

        View mView;
        public JatrabariRidePostViewHolder(@NonNull View itemView) {
            super(itemView);
