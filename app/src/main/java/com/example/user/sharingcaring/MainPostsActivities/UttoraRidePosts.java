...
import com.example.user.sharingcaring.ExpnadablePlaceName.Uttara;
...
public class UttoraRidePosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttora_ride_posts);

        rideShareBar=findViewById(R.id.uttara_ride_app_bar);
        setSupportActionBar(rideShareBar);
        getSupportActionBar().setTitle("Uttara Area");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        postRef=FirebaseDatabase.getInstance().getReference().child("UttaraPosts");

        rideSharePostList=findViewById(R.id.uttara_rideShare_post_recyclerView);
        ...
        floatingActionButton=findViewById(R.id.uttara_openRide_post);
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(UttoraRidePosts.this,Uttara.class);
    ...
    private void displayAllUserPosts() {
        ...
        FirebaseRecyclerAdapter<RideSharePostModel,UttoraRidePostViewHolder> firebaseRecyclerAdapter=
                new FirebaseRecyclerAdapter<RideSharePostModel, UttoraRidePostViewHolder>
                        (RideSharePostModel.class,R.layout.ride_share_post_layout,UttoraRidePostViewHolder.class,postRef) {
                    @Override
                    protected void populateViewHolder(UttoraRidePostViewHolder viewHolder, final RideSharePostModel model, int position) {
    ...
    public static class UttoraRidePostViewHolder extends RecyclerView.ViewHolder{

        View mView;
        public UttoraRidePostViewHolder(@NonNull View itemView) {
            super(itemView);
